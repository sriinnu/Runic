                ...
                SettingsSection(contentSpacing: 8) {
                    ...
                    HStack(spacing: 12) {
                        Text("Menu list size")
                            .font(.body)
                        Spacer()
                        Stepper(value: self.$settings.insightsMenuMaxItems, in: 2...8) {
                            Text("\(self.settings.insightsMenuMaxItems) items")
                        }
                        .labelsHidden()
                    }
                    Text("Limits insight rows shown in the menu before “More…”.")
                        .font(.footnote)
                    ...
                    HStack(spacing: 12) {
                        Text("Report window")
                            .font(.body)
                        Spacer()
                        Stepper(value: self.$settings.insightsReportDays, in: 1...30) {
                            Text("Last \(self.settings.insightsReportDays) days")
                        }
                        .labelsHidden()
                    }
                    Text("Used when opening the Insights report.")
                        .font(.footnote)
                        .foregroundStyle(.tertiary)
                }
