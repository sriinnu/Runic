...
enum RunicFont {
    ...
    private static var isSystemFont: Bool { family.hasPrefix("__") }
    ...
    static var caption2: Font { makeFont(size: 10, relativeTo: .caption2) }
    static var caption: Font { makeFont(size: 11, relativeTo: .caption) }
    static var footnote: Font { makeFont(size: 12, relativeTo: .footnote) }
    static var callout: Font { makeFont(size: 13, relativeTo: .callout) }
    static var body: Font { makeFont(size: 13, relativeTo: .body) }
    static var subheadline: Font { makeFont(size: 12, relativeTo: .subheadline) }
    static var headline: Font { makeFont(size: 13, relativeTo: .headline).weight(.bold) }
    static var title3: Font { makeFont(size: 15, relativeTo: .title3) }
    static var title2: Font { makeFont(size: 17, relativeTo: .title2) }
    static var title: Font { makeFont(size: 22, relativeTo: .title) }
    static var largeTitle: Font { makeFont(size: 26, relativeTo: .largeTitle) }

    /// Custom fixed size.
    static func system(size: CGFloat) -> Font {
        switch family {
        case RunicFontChoice.sfPro.id: return .system(size: size)
        case RunicFontChoice.sfMono.id: return .system(size: size, design: .monospaced)
        default: return Font.custom(family, fixedSize: size)
        }
    }
    ...
    static func system(size: CGFloat, weight: Font.Weight) -> Font {
        switch family {
        case RunicFontChoice.sfPro.id: return .system(size: size, weight: weight)
        case RunicFontChoice.sfMono.id: return .system(size: size, weight: weight, design: .monospaced)
    ...
    private static func makeFont(size: CGFloat, relativeTo style: Font.TextStyle) -> Font {
        switch family {
        case RunicFontChoice.sfPro.id: return .system(style)
        case RunicFontChoice.sfMono.id: return .system(style, design: .monospaced)
        default: return Font.custom(family, size: size, relativeTo: style)
        }
    }
}
