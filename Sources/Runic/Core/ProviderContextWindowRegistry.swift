...
private struct ProviderContextSnapshot: Sendable {
    let discoveredAt: Date?
    let providersByID: [String: ContextProvider]
    let modelsByProviderID: [String: [ContextModel]]
}

private struct ContextProvider: Sendable {
...
private struct ContextModel: Sendable {
    let key: String
    let modelID: String
    let name: String?
    let aliases: [String]
...
private struct KoshaSnapshotRaw: Decodable {
...
private struct KoshaProviderRaw: Decodable {
    let providerId: String?
    let canonicalProviderId: String?
    let aliases: [String]?
...
private struct KoshaModelRaw: Decodable {
    let key: String?
    let modelId: String?
    let name: String?
    let providerId: String?
