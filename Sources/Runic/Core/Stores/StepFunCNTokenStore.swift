...
protocol StepFunCNTokenStoring: Sendable {
    func loadToken() throws -> String?
    func storeToken(_ token: String?) throws
}

struct KeychainStepFunCNTokenStore: StepFunCNTokenStoring {
    private static let log = RunicLog.logger("stepfun-cn-token-store")

    private let service = RunicKeychainService.providerCredentials
    private let account = "stepfun-cn-api-token"
