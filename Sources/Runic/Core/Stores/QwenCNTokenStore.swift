...
protocol QwenCNTokenStoring: Sendable {
    func loadToken() throws -> String?
    func storeToken(_ token: String?) throws
}

struct KeychainQwenCNTokenStore: QwenCNTokenStoring {
    private static let log = RunicLog.logger("qwen-cn-token-store")

    private let service = RunicKeychainService.providerCredentials
    private let account = "qwen-cn-api-token"
