...
protocol KimiCNTokenStoring: Sendable {
    func loadToken() throws -> String?
    func storeToken(_ token: String?) throws
}

struct KeychainKimiCNTokenStore: KimiCNTokenStoring {
    private static let log = RunicLog.logger("kimi-cn-token-store")

    private let service = RunicKeychainService.providerCredentials
    private let account = "kimi-cn-api-token"
