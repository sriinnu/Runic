...
protocol StepFunTokenStoring: Sendable {
    func loadToken() throws -> String?
    func storeToken(_ token: String?) throws
}

struct KeychainStepFunTokenStore: StepFunTokenStoring {
    private static let log = RunicLog.logger("stepfun-token-store")

    private let service = RunicKeychainService.providerCredentials
    private let account = "stepfun-api-token"
