...
public enum ProviderDescriptorRegistry {
    ...
    private static let bootstrap: Void = {
        ...
        _ = ProviderDescriptorRegistry.register(KimiCNProviderDescriptor.descriptor)
        _ = ProviderDescriptorRegistry.register(ZaiCNProviderDescriptor.descriptor)
        _ = ProviderDescriptorRegistry.register(MiniMaxCNProviderDescriptor.descriptor)
        _ = ProviderDescriptorRegistry.register(StepFunProviderDescriptor.descriptor)
        _ = ProviderDescriptorRegistry.register(StepFunCNProviderDescriptor.descriptor)
