---
summary: "Sparkle integration details for Runic: updater config, keys, and release flow."
read_when:
...
- Runic disables Sparkle in Homebrew and unsigned builds; those installs should be updated via `brew` or reinstalling from Releases.
