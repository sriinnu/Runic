...
./Scripts/make_appcast.sh CodexBar-0.1.0.zip \
  https://raw.githubusercontent.com/sriinnu/CodexBar/main/appcast.xml
...
- [ ] Generate Sparkle appcast with private key
  ...
  - Generate the appcast + HTML release notes: `./Scripts/make_appcast.sh CodexBar-<ver>.zip https://raw.githubusercontent.com/sriinnu/CodexBar/main/appcast.xml`
...
- [ ] Homebrew tap: update `../homebrew-tap/Casks/codexbar.rb` (url + sha256), then verify:
  ...
  - `brew install --cask sriinnu/tap/codexbar && open -a CodexBar`
