---
summary: "Convert macOS .icon bundles to Runic .icns via Scripts/build_icon.sh and ictool."
read_when:
  - Updating the Runic app icon or asset pipeline
...
## Script
`Scripts/build_icon.sh ICON.icon Runic [outdir]`
